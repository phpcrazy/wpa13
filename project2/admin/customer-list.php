...
<head>
  ...
  <title>WPA13 - Fashion | Admin <Customer-List></title>
        ...
        <div class="row">
          <div class="col-1">
            ...
            <div class="page-header">
              <h2>Customer <small>List /  Search </small></h2>
            </div>
            ...
            <div class="search-panel rounded-corners">
              ...
              <!--Start Row = 6 -->
              <div class="col-md-6">
                <a class="btn btn-danger" href="customer-list.php">Search</a>
                <a class="btn btn-danger" href="customer-list.php">Show All</a>
              </div>  
              <!--End Row = 6 -->             
            </div>     
          </div>
          ...
          <!--Start New Section-->
          <a class="btn btn-danger" href="customer-new.php">New</a>                     
          <!--End New Section-->
